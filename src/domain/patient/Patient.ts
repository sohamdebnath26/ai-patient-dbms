...
export const UpdatePatientSchema = z.object({
  ...
  previous_skin_diseases: z.string().nullable().optional(),
  previous_surgeries: z.string().nullable().optional(),
  other_medical_conditions: z.string().nullable().optional(),
  family_history_skin: z.string().nullable().optional(),
  family_history_cancer: z.string().nullable().optional(),
  ...
  date_of_onset: z.string().nullable().optional(),
